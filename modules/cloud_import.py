...
async def handler(query: dict, request) -> dict:
    ...
    res = await request("/api/cloud/upload/check/v2", check_data, create_option(query))
    ...
    return await request("/api/cloud/user/song/import", import_data, create_option(query))
